...
* #### Block Code: 1111
  ...
  * Block Format:
    * 1x (uint8) AMG8833 I2C address or ID. 
    * 1x (uint32) millisecond timestamp. (64x float32 pixel values)
...
* #### Block Code: 1112
  ...
  * Block Format:
    * 1x (uint8) AMG8833 I2C address or ID. 
    * 1x (uint32) millisecond timestamp. (64x int16 pixel values)
...
* #### Block Code: 1113
  ...
  * Block Format:
    ...
    * 1x (uint32) millisecond timestamp. (1024x uint8 pixel values)
...
* #### Block Code: 1701
  ...
  * Description: ."Current configuration values for the ZMOD4410.,
    * 1x (uint8) ZMOD4410 I2C address or ID. (6x uint8 register values)
...
* #### Block Code: 1801
  ...
  * Description: ."Current magnetometer reading settings on any enabled LSM303., byte LSM303 I2C address or ID. 
    * 1x (uint32) millisecond timestamp. 
    * 1x (uint32) driver version. 
    * 1x (uint32) unique identifier. 
    * 1x (float32) range maximum. 
...
* #### Block Code: 1901
  ...
  * Block Format:
    ...
    * Nx repetitions of (Nx float64 intensity values)]
