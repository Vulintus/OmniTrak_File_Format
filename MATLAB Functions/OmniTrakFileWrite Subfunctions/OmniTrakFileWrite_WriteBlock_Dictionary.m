...
% CAPSENSE_BITMASK (0x0A10): Capacitive sensor status bitmask, typically written only when it changes.
...
% CAPSENSE_VALUE (0x0A11): Capacitive sensor reading for one sensor, in ADC ticks or clock cycles.
