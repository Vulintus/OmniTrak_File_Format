...
file_writer.htpa32x32_pixels_fp62 = @(thermal_data)OmniTrakFileWrite_WriteBlock_V1_HTPA32X32_PIXELS_FP62(fid, ofbc.HTPA32X32_PIXELS_FP62, thermal_data);

% HTPA32X32_PIXELS_INT_K: 1114
% HTPA32X32_AMBIENT_TEMP: 1115
% HTPA32X32_PIXELS_INT12_C: 1116
% HTPA32X32_HOTTEST_PIXEL_FP62: 1117
file_writer.htpa32x32_hottest_pixel_fp62 = @(thermal_data)OmniTrakFileWrite_WriteBlock_V1_HTPA32X32_HOTTEST_PIXEL_FP62(fid, ofbc.HTPA32X32_HOTTEST_PIXEL_FP62, thermal_data);
