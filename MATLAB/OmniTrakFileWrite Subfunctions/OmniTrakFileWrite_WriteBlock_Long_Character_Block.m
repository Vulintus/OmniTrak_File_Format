function OmniTrakFileWrite_WriteBlock_Long_Character_Block(fid, block_code, str)

%
%OmniTrakFileWrite_WriteBlock_Long_Character_Block.m - Vulintus, Inc.
%
%   OMNITRAKFILEWRITE_WRITEBLOCK_LONG_CHARACTER_BLOCK adds the
